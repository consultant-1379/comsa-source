...
PmSaSelectTimer::PmSaSelectTimer()
{
...
struct timeval* PmSaSelectTimer::timerGetDelay_r(void* handle)
{
	struct timeval tv;
...
void PmSaSelectTimer::rescedule(struct TimeHandle* th, struct TimerInternal* t, struct timeval* tv)
{
	struct TimerInternal* item;
...
void* PmSaSelectTimer::timerCreateHandle_r(void)
{
    ENTER_PMTSA();
...
void PmSaSelectTimer::poll_maxfd(void* handle, int maxfd)
{
...
int PmSaSelectTimer::poll_setcallback(void* handle, FdCallbackFn fn, struct pollfd pfd, void *ref)
{
        ENTER_PMTSA();
	unsigned int i;
	pollextensionsT* e;
...
void PmSaSelectTimer::poll_unsetcallback(void* handle, int fd)
{
        ENTER_PMTSA();
	unsigned int i;
	int index = -1;
...
int PmSaSelectTimer::poll_execute(void* handle)
{
