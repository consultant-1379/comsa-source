 ...
 *
 *
 *   File:   com_ericsson_common_comsa_imm_om.h
 *
 *   Author: eerwest
 *
 *   Date:   2014-03-31
...
#define TRACEPOINT_PROVIDER com_ericsson_common_comsa_imm_om

#undef TRACEPOINT_INCLUDE
#define TRACEPOINT_INCLUDE "./com_ericsson_common_comsa_imm_om.h"

#if !defined(COM_ERICSSON_COMMON_COMSA_IMM_OM_H_) || defined(TRACEPOINT_HEADER_MULTI_READ)
#define COM_ERICSSON_COMMON_COMSA_IMM_OM_H_

#include "lttng/tracepoint.h"


TRACEPOINT_EVENT(com_ericsson_common_comsa_imm_om, COMSA_ERROR,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_imm_om, COMSA_ERROR, TRACE_ERR)


TRACEPOINT_EVENT(com_ericsson_common_comsa_imm_om, COMSA_WARNING,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_imm_om, COMSA_WARNING, TRACE_WARNING)


TRACEPOINT_EVENT(com_ericsson_common_comsa_imm_om, COMSA_LOG,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_imm_om, COMSA_LOG, TRACE_INFO)


TRACEPOINT_EVENT(com_ericsson_common_comsa_imm_om, COMSA_SA_INIT,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_imm_om, COMSA_SA_INIT, TRACE_DEBUG_PROCESS)


TRACEPOINT_EVENT(com_ericsson_common_comsa_imm_om, COMSA_SA_START,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_imm_om, COMSA_SA_START, TRACE_DEBUG_PROCESS)


TRACEPOINT_EVENT(com_ericsson_common_comsa_imm_om, COMSA_SA_STOP,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_imm_om, COMSA_SA_STOP, TRACE_DEBUG_PROCESS)


TRACEPOINT_EVENT(com_ericsson_common_comsa_imm_om, COMSA_ENTER,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_imm_om, COMSA_ENTER, TRACE_DEBUG_FUNCTION)


TRACEPOINT_EVENT(com_ericsson_common_comsa_imm_om, COMSA_LEAVE,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_imm_om, COMSA_LEAVE, TRACE_DEBUG_FUNCTION)


TRACEPOINT_EVENT(com_ericsson_common_comsa_imm_om, COMSA_DEBUG,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_imm_om, COMSA_DEBUG, TRACE_DEBUG)

#endif /* COM_ERICSSON_COMMON_COMSA_IMM_OM_H_ */
