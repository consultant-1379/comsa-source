 ...
 *
 *
 *   File:   com_ericsson_common_comsa_mwsa_ac.h
 *
 *   Author: eerwest
 *
 *   Date:   2014-03-31
...
#define TRACEPOINT_PROVIDER com_ericsson_common_comsa_mwsa_ac

#undef TRACEPOINT_INCLUDE
#define TRACEPOINT_INCLUDE "./com_ericsson_common_comsa_mwsa_ac.h"

#if !defined(COM_ERICSSON_COMMON_COMSA_MWSA_AC_H_) || defined(TRACEPOINT_HEADER_MULTI_READ)
#define COM_ERICSSON_COMMON_COMSA_MWSA_AC_H_

#include "lttng/tracepoint.h"


TRACEPOINT_EVENT(com_ericsson_common_comsa_mwsa_ac, COMSA_ERROR,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_mwsa_ac, COMSA_ERROR, TRACE_ERR)


TRACEPOINT_EVENT(com_ericsson_common_comsa_mwsa_ac, COMSA_WARNING,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_mwsa_ac, COMSA_WARNING, TRACE_WARNING)


TRACEPOINT_EVENT(com_ericsson_common_comsa_mwsa_ac, COMSA_LOG,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_mwsa_ac, COMSA_LOG, TRACE_INFO)


TRACEPOINT_EVENT(com_ericsson_common_comsa_mwsa_ac, COMSA_SA_INIT,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_mwsa_ac, COMSA_SA_INIT, TRACE_DEBUG_PROCESS)


TRACEPOINT_EVENT(com_ericsson_common_comsa_mwsa_ac, COMSA_SA_START,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_mwsa_ac, COMSA_SA_START, TRACE_DEBUG_PROCESS)


TRACEPOINT_EVENT(com_ericsson_common_comsa_mwsa_ac, COMSA_SA_STOP,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_mwsa_ac, COMSA_SA_STOP, TRACE_DEBUG_PROCESS)


TRACEPOINT_EVENT(com_ericsson_common_comsa_mwsa_ac, COMSA_ENTER,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_mwsa_ac, COMSA_ENTER, TRACE_DEBUG_FUNCTION)


TRACEPOINT_EVENT(com_ericsson_common_comsa_mwsa_ac, COMSA_LEAVE,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_mwsa_ac, COMSA_LEAVE, TRACE_DEBUG_FUNCTION)


TRACEPOINT_EVENT(com_ericsson_common_comsa_mwsa_ac, COMSA_DEBUG,
...
TRACEPOINT_LOGLEVEL(com_ericsson_common_comsa_mwsa_ac, COMSA_DEBUG, TRACE_DEBUG)

#endif /* COM_ERICSSON_COMMON_COMSA_MWSA_AC_H_ */
