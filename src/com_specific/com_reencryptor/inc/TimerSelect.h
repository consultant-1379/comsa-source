#ifndef TimerSelect_H
#define TimerSelect_H
#include <stdlib.h>
#include <sys/time.h>
#include <poll.h>
#include <assert.h>
...
/**
 * @defgroup TimerSelect Timer and poll call-back framework.
...
class TimerSelect
{
	TimerSelect();
public:
	static TimerSelect& Instance() {
			static TimerSelect TimerSelect;
			return TimerSelect;
	}
