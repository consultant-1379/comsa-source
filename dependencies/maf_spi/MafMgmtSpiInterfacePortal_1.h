#ifndef MafMgmtSpiInterfacePortal_1_h
#define MafMgmtSpiInterfacePortal_1_h
 ...
 * Interface portal.
 *
 * @file MafMgmtSpiInterfacePortal_1.h
 * @ingroup MafMgmtSpi
 *
 * MafMgmtSpiInterfacePortal_1 contains function pointers for accessing the
 ...
 */
typedef struct MafMgmtSpiInterfacePortal_1 {
    /**
     ...
     */
    MafReturnT (*registerComponent)(MafMgmtSpiComponent_1T *component);
    /**
     ...
     * one of the other MafReturnT return codes.
     */
    MafReturnT (*unregisterComponent)(MafMgmtSpiComponent_1T *component);
} MafMgmtSpiInterfacePortal_1T;
