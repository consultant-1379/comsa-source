#ifndef MafOamSpiManagedObject_1_h
#define MafOamSpiManagedObject_1_h
 ...
 *
 * @file MafOamSpiManagedObject_1.h
 * @ingroup MafOamSpi
 *
 ...
 * Forward declaration.
 */
struct MafMoAttributeValueStructMember;
struct MafMoAttributeValueContainer;

/**
 * A container for one attribute value.
 */
typedef struct MafMoAttributeValue {
    ...
    union {
         ...
         */
        struct MafMoAttributeValueStructMember * structMember;
    } value;
} MafMoAttributeValueT;

/**
 * Used for the struct members. A struct contains one or more
 * members.
 */
typedef struct MafMoAttributeValueStructMember {
     ...
     * Value of the member.
     */
    struct MafMoAttributeValueContainer * memberValue;

    /**
     * Pointer to the next struct member, or null if
     * there are no more structs.
     */
    struct MafMoAttributeValueStructMember *next;

} MafMoAttributeValueStructMemberT;
 ...
 */
typedef struct MafMoAttributeValueContainer {
    /**
     ...
     */
    struct MafMoAttributeValue *values;
 ...
 *
 * The implementation of MafOamSpiManagedObject_1 must ensure the
 ...
 */
typedef struct MafOamSpiManagedObject_1 {
    /**
    ...
    MafReturnT (*setMoAttribute)(MafOamSpiTransactionHandleT txHandle,
                                 ...
                                 const MafMoAttributeValueContainerT * attributeValue);
    /**
    ...
    MafReturnT (*getMoAttribute)(MafOamSpiTransactionHandleT txHandle,
                                 const char * dn,
                                 const char * attributeName,
                                 MafMoAttributeValueContainerT  ** result);
    /**
     ...
     * @code
     * ...
     * MafOamSpiManagedObject_1T * totalModel;
    ...
    MafReturnT (*action)(MafOamSpiTransactionHandleT txHandle,
                         const char * dn,
                         const char * name,
                         MafMoAttributeValueContainerT **parameters,
                         MafMoAttributeValueContainerT **result);

} MafOamSpiManagedObject_1T;
