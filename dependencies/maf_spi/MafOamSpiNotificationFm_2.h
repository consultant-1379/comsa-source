#ifndef MafOamSpiNotificationFm_2_h__
#define MafOamSpiNotificationFm_2_h__
...
/**
 * @file MafOamSpiNotificationFm_2.h
 * @ingroup MafOamSpi
 *
 ...
 */
#define MafOamSpiNotificationFmEventType_2 "MafOamSpiNotificationFmEventType_2"
 ...
 */
#define MafOamSpiNotificationFmFilterTypeDateTime_2 "MafOamSpiNotificationFmFilterTypeDateTime_2"

/**
 * Value of MafOamSpiNotificationFmFilterTypeDateTime_2 filter. Its time
 * represents nanoseconds since the Epoch.
 */
typedef uint64_t MafOamSpiNotificationFmFilterDateTimeValue_2T;

/**
 * Structure to handle the alarm object.
 */
typedef struct MafOamSpiNotificationFmStruct_2 {
    /**
...
} MafOamSpiNotificationFmStruct_2T;
