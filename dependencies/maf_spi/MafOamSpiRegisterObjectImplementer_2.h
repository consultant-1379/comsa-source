#ifndef MafOamSpiRegisterObjectImplementer_2_h_
#define MafOamSpiRegisterObjectImplementer_2_h_
 ...
 *
 * @file MafOamSpiRegisterObjectImplementer_2.h
 * @ingroup MafOamSpi
 *
...
/*
 * @deprecated replaced by MafOamSpiRegisterObjectImplementer_3
 */
typedef struct MafOamSpiRegisterObjectImplementer_2 {
    ...
    MafReturnT (*unregisterDn)(MafMgmtSpiInterface_1T managedObjectInterfaceId,
                               MafMgmtSpiInterface_1T transactionalResourceId,
                               const char * dn);
} MafOamSpiRegisterObjectImplementer_2T;
