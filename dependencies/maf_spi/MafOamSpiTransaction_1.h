#ifndef MafOamSpiTransaction_1_h
#define MafOamSpiTransaction_1_h
 ...
 */
typedef enum  {
    /** Lock on write, create, and delete */
    MafLockWrite = 1,
    /** Lock on read, write, create, and delete */
    MafLockReadWrite = 2
} MafLockPolicyT;
 ...
 * Transaction interface.
 */
typedef struct MafOamSpiTransaction_1 {
    /**
    ...
    MafReturnT (*registerParticipant)(MafOamSpiTransactionHandleT txHandle,
                                      MafOamSpiTransactionalResource_1T * resource);
    /**
