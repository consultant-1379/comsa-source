...
#ifndef ComOamSpiPmMeasurements_3_h__
#define ComOamSpiPmMeasurements_3_h__
...
/**
*******************************************************************************************
* @file ComOamSpiPmMeasurements_3.h
...
*/
typedef struct ComOamSpiPmMeasurementValue_3 {
    /**
...
} ComOamSpiPmMeasurementValue_3T;

/**
* The value type of a measurement.
*/
typedef enum ComOamSpiPmMeasurementValueType_3 {
    ComOamSpiPmMeasurementValueType_3_INT = 0,
    ComOamSpiPmMeasurementValueType_3_FLOAT = 1

} ComOamSpiPmMeasurementValueType_3T;


/**
* A container struct for a measurement definition
*/
typedef struct ComOamSpiPmMeasurementDefinition_3 {
...
} ComOamSpiPmMeasurementDefinition_3T;


/**
* A container struct for a measurement
*/
typedef struct ComOamSpiPmMeasurement_3 {
     ...
     */
    ComOamSpiPmMeasurementValue_3T* value;

    /**
     * The type of value, that is int or float.
     */
    ComOamSpiPmMeasurementValueType_3T valueType;
...
typedef struct ComOamSpiPmMeasuredObject_3 {
     ...
     */
    ComOamSpiPmMeasurement_3T* measurements;
...
typedef struct ComOamSpiPmMeasuredObjectMeasurementNames_3 {
     ...
     */
    void (*release)(struct ComOamSpiPmMeasuredObjectMeasurementNames_3* measurementNames);

} ComOamSpiPmMeasuredObjectMeasurementNames_3T;


/**
* A struct for a measurement filter
*/
typedef struct ComOamSpiPmMeasurementFilter_3 {
...
} ComOamSpiPmMeasurementFilter_3T;


/**
* A struct containing all measurement job IDs associated to a measured object
*/
typedef struct ComOamSpiPmMeasuredObjectJobIds_3 {
    /**
     ...
     */
    void (*release)(struct ComOamSpiPmMeasuredObjectJobIds_3* ids);

}  ComOamSpiPmMeasuredObjectJobIds_3T;


/**
* PM measurement interface. Implemented by the SA to provide real-time access to measurement values.
*/
typedef struct ComOamSpiPmMeasurements_3 {
    ...
    * The "base class" for this interface contains the
     ...
     */
    MafReturnT (*getMeasurementValues)(const char * dn, const ComOamSpiPmMeasurementFilter_3T* filter, ComOamSpiPmMeasuredObject_3T * measuredObject);
...
} ComOamSpiPmMeasurements_3T;

#endif // ComOamSpiPmMeasurements_3_h__
