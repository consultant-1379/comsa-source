#ifndef ComOamSpiRegisterObjectImplementer_2_h_
#define ComOamSpiRegisterObjectImplementer_2_h_
 ...
 *
 * @file ComOamSpiRegisterObjectImplementer_2.h
 *
 ...
 * by the ComOamSpiCmRouterService, routing the call to the apropriate destination,
 * for example the OamSa.
 */

typedef struct ComOamSpiRegisterObjectImplementer_2 {
    ...
    ComReturnT (*unregisterDn)(ComMgmtSpiInterface_1T managedObjectInterfaceId,
                               ComMgmtSpiInterface_1T transactionalResourceId,
                               const char * dn);
} ComOamSpiRegisterObjectImplementer_2T;
