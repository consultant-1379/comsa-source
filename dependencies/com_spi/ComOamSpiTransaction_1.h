#ifndef ComOamSpiTransaction_1_h
#define ComOamSpiTransaction_1_h
 ...
 * Transaction interface.
 */
typedef struct ComOamSpiTransaction_1 {
    /**
    ...
    ComReturnT (*registerParticipant)(ComOamSpiTransactionHandleT txHandle,
                                      ComOamSpiTransactionalResource_1T * resource);
    /**
